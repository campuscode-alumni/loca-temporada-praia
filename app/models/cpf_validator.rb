class CpfValidator < ActiveModel::EachValidator
  ...
  def blacklist
    [12345678909, 11111111111, 22222222222, 33333333333, 44444444444, 55555555555, 66666666666, 77777777777, 88888888888, 99999999999, 00000000000, 12345678909]
  end

  def cpf_valid?(cpf)
    if cpf.length == 11 and !blacklist.member?(cpf)
      cpf_algorithm cpf
    end
  end
